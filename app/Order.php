...
{
    protected $fillable = ['userID', 'cartID', 'subtotal', 'deliveryfee', 'total', 'boutiqueID', 'deliveryAddress', 'status', 'rentID', 'paymentStatus', 'mtoID', 'deliverySchedule', 'alterationSchedule'];
