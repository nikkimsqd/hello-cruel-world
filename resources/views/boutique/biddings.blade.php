        ...
        <div class="col-md-4 bid-item">
          ...
          <!-- <div class="row"> -->
            <a href="{{ url('viewproduct/'.$bidding['id']) }}">
              <h4>{{ $bidding['maxPriceLimit'] }}</h4>
            </a>
            <h2></h2>

            <div class="hover-content">
              <a href="{{ url('viewproduct/'.$bidding['id']) }}" class="btn btn-block btn-lg btn-success btn-flat view-bidding" hidden>View Bidding</a>
            </div>
          <!-- </div> -->
        </div>
      <!-- </div> -->
...
.hover-content{position: absolute; width: calc(100% - 40px); bottom: 73px; left: 20px; right: 20px; opacity: 0; visibility: hidden; -webkit-transition-duration: 500ms; transition-duration: 500ms;};
