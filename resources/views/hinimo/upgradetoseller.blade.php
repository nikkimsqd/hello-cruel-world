                ...
                <div class="col-12 col-md-6">
                    <div class="regular-page-content-wrapper section-padding-80">
                        <div class="regular-page-text">
                            <form action="{{url('/save-boutique')}}" method="post">
                            {{ csrf_field() }}
                                Boutique Name:
                                <input type="text" name="boutiqueName" class="input form-control"><br>
                                Boutique Address:
                                <textarea name="boutiqueAddress" rows="2" cols="50" class="input form-control"></textarea><br><br>

                                <input type="submit" name="btn_submit" value="Register" class="btn essence-btn">
