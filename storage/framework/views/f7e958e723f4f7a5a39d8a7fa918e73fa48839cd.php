...
<br><br>
	...
	<div class="row">
		<!-- <div class="col-md-12 text-left animate-box" style="background-color: #f2f2f2;"> -->
			<div class="col-md-4">
					...
					<br>
					<img src="<?php echo e(asset('long/custom.jpg')); ?>" style="height: 400px;">
					<br><br>
	...
	<div class="row">
		<div class="col-md-12 img text-right animate-box services">
			...
			<div class="col-md-4">
					...
					<img src="<?php echo e(asset('long/h.jpg')); ?>" style="height: 400px;">
					<br><br>
	...
	<div class="row" style="background-color: #f2f2f2;">
		...
		<div class="col-md-4 text-center animate-box">
			<div class="">
				<span class="icon">
					<img src="<?php echo e(asset('male.png')); ?>">
				</span>
				<div class="desc">
					<h3>Select Fabric</h3>
					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
		...
		<div class="col-md-4 text-center animate-box">
			<div>
				<span class="icon">
					<img src="<?php echo e(asset('female.png')); ?>">
				</span>
				<div class="desc">
		...
		<div class="col-md-4 text-center animate-box">
			<div>
				<span class="icon">
					<img src="<?php echo e(asset('bg.png')); ?>">
				</span>
				<div class="desc">
...
<?php echo $__env->make('layouts.userindex', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>